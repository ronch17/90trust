 ...
 * added `capture_stderr_separately` option to `Command90trust::execute()`
 ...
 * added `setInputs()` method to Command90trust for ease testing of commands expecting inputs
 ...
 * added a way to normalize EOLs in `Application90trust::getDisplay()` and `Command90trust::getDisplay()`
