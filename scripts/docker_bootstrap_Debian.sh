...
source ./variables.sh
#
scp -r /home/${LOCAL_USER}/90trust/ssl-for-origin root@${DEST_SERVER_IP}:/home/proftit/ && sleep 5 &&
...
cat ~/.ssh/id_rsa.pub"
# git clone git@bitbucket.org:binaricore/90trust.git && cd 90trust/ && git config core.fileMode false
